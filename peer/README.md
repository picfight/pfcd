...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/picfight/dcrd/peer)
...
```bash
$ go get -u github.com/picfight/dcrd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/picfight/dcrd/peer#example-package--NewOutboundPeer)  
