...
func (r FutureGetCurrentNetResult) Receive() (wire.PicfightcoinNet, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	return wire.PicfightcoinNet(net), nil
}
...
//
// NOTE: This is a pfcd extension.
func (c *Client) GetCurrentNet() (wire.PicfightcoinNet, error) {
...
func (c *Client) GetHeadersAsync(blockLocators []chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := pfcjson.NewGetHeadersCmd(locators, hash)
	return c.sendCmd(cmd)
}
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureVersionResult) Receive() (map[string]pfcjson.VersionResult,
	error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
