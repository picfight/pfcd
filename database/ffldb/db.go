...
import (
	...
	"github.com/picfight/pfcd/database/internal/treap"
...
//
// This function is part of the database.Tx interface implementation.
func (tx *transaction) StoreBlock(block *pfcutil.Block) error {
	// Ensure transaction state is valid.
...
//
// For example, it is possible to directly extract Picfightcoin transactions and/or
...
func openDB(dbPath string, network wire.PicfightcoinNet, create bool) (database.DB, error) {
