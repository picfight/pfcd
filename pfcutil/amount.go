...
// units, "1eN PFC" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " PFC"
	}
}
...
//
// NewAmount is for specifically for converting PFC to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/picfight/pfcd/pfcutil#example-Amount
...
// useful for services that build on top of Picfight (for example, calculating
