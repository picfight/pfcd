...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/picfight/pfcd/pfcutil/txsort)
...
differences with PicFight-specific transactions.
...
```bash
$ go get -u github.com/picfight/pfcd/pfcutil/txsort
```
