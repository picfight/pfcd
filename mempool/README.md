...
Package mempool provides a policy-enforced pool of unmined picfightcoin transactions.

A key responsbility of the picfightcoin network is mining user-generated transactions
...
Since this package does not deal with other picfightcoin specifics such as network
...
```bash
$ go get -u github.com/picfight/pfcd/mempool
```
