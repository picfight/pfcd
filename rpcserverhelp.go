...
var helpDescsEnUS = map[string]string{
	...
	"scriptpubkeyresult-addresses": "The picfightcoin addresses associated with this script",
	...
	"decodescriptresult-addresses": "The picfightcoin addresses associated with this script",
	...
	"getcurrentnet--synopsis": "Get picfightcoin network the server is running on.",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in PFC/KB",
	...
	"infowalletresult-balance":         "The total picfightcoin balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in PFC/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in PFC/KB",
	...
	"gettxoutresult-value":         "The transaction amount in PFC",
	...
	"searchrawtransactions-address":     "The Picfightcoin address to search for",
	...
	"validateaddresschainresult-address": "The picfightcoin address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Picfightcoin address to validate",
	...
	"verifymessage-address":   "The picfightcoin address to use for the signature",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this pfcd instance) and when such a transaction first appears in a newly-attached block.",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"getnettotals":          {(*pfcjson.GetNetTotalsResult)(nil)},
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := pfcjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := pfcjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
