...
// picfightGenesisCoinbaseTx is the coinbase transaction for the genesis blocks for
// the main network.
var picfightGenesisCoinbaseTx = wire.MsgTx{
...
// picfightGenesisMerkleRoot is the hash of the first transaction in the genesis block
// for the main network.
var picfightGenesisMerkleRoot = picfightGenesisCoinbaseTx.TxHashFull()

// picfightGenesisBlock defines the genesis block of the block chain which serves as the
...
var picfightGenesisBlock = wire.MsgBlock{
	...
	Transactions: []*wire.MsgTx{&picfightGenesisCoinbaseTx},
}

// picfightGenesisHash is the hash of the first block in the block chain for the main
// network (genesis block).
var picfightGenesisHash = picfightGenesisBlock.BlockHash()

// picfightGenesisCoinbaseTxLegacy is the coinbase transaction for the genesis block for
// the test network.
var picfightGenesisCoinbaseTxLegacy = wire.MsgTx{
	SerType: wire.TxSerializeFull,
	Version: 1,
	TxIn: []*wire.TxIn{
		{
...
// the main network.
var decredGenesisCoinbaseTx = wire.MsgTx{
	SerType: wire.TxSerializeFull,
	Version: 1,
	TxIn: []*wire.TxIn{
		{
...
// decredGenesisMerkleRoot is the hash of the first transaction in the genesis block
// for the main network.
var decredGenesisMerkleRoot = decredGenesisCoinbaseTx.TxHashFull()

// decredGenesisBlock defines the genesis block of the block chain which serves as the
// public transaction ledger for the main network.
//
// The genesis block for Decred mainnet, testnet, and simnet are not evaluated
// for proof of work. The only values that are ever used elsewhere in the
...
// The genesis block is valid by definition and none of the fields within
// it are validated for correctness.
var decredGenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		Version:      1,
		PrevBlock:    chainhash.Hash{},
		MerkleRoot:   decredGenesisMerkleRoot,
		StakeRoot:    chainhash.Hash{},
	...
	Transactions: []*wire.MsgTx{&decredGenesisCoinbaseTx},
}

// decredGenesisHash is the hash of the first block in the block chain for the main
// network (genesis block).
var decredGenesisHash = decredGenesisBlock.BlockHash()

// decredGenesisCoinbaseTxLegacy is the coinbase transaction for the genesis block for
// the test network.
var decredGenesisCoinbaseTxLegacy = wire.MsgTx{
	SerType: wire.TxSerializeFull,
	Version: 1,
	TxIn: []*wire.TxIn{
		{
...
var testNet3GenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		Version:      6,
		PrevBlock:    chainhash.Hash{},
		MerkleRoot:   picfightGenesisCoinbaseTx.TxHash(),
...
// the main network.
var simNetGenesisMerkleRoot = picfightGenesisMerkleRoot
...
// the main network.
var regNetGenesisMerkleRoot = picfightGenesisMerkleRoot
