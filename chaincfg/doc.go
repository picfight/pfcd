...
//
// In addition to the main Picfight network, which is intended for the transfer
...
// wire.PicfightNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := pfcutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the three standard Picfight networks,
