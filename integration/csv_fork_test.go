...
func makeTestOutput(r *rpctest.Harness, t *testing.T,
	...
	// spend.
	a, err := pfcutil.NewAddressPubKey(key.PubKey().SerializeCompressed(), r.ActiveNet)
	if err != nil {
		return nil, nil, nil, err
	}
...
func TestBIP0113Activation(t *testing.T) {
	...
	const outputValue = pfcutil.SatoshiPerBitcoin
...
func createCSVOutput(r *rpctest.Harness, t *testing.T,
	...
	p2shAddr, err := pfcutil.NewAddressScriptHash(csvScript, r.ActiveNet)
	if err != nil {
		return nil, nil, nil, err
	}
...
func TestBIP0068AndBIP0112Activation(t *testing.T) {
	...
	const (
		outputAmt         = pfcutil.SatoshiPerBitcoin
