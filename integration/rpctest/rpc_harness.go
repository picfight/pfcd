...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*pfcutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []pfcutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (pfcutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() pfcutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*pfcutil.Tx, blockVersion int32,
	blockTime time.Time) (*pfcutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*pfcutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*pfcutil.Block, error) {
...
func baseDir() (string, error) {
	dirPath := filepath.Join(os.TempDir(), "pfcd", "rpctest")
