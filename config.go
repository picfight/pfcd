...
type config struct {
	...
	AgentBlacklist       []string      `long:"agentblacklist" description:"A comma separated list of user-agent substrings which will cause pfcd to reject any peers whose user-agent contains any of the blacklisted substrings."`
	AgentWhitelist       []string      `long:"agentwhitelist" description:"A comma separated list of user-agent substrings which will cause pfcd to require all peers' user-agents to contain one of the whitelisted substrings. The blacklist is applied before the blacklist, and an empty whitelist will allow all agents that do not fail the blacklist."`
	...
	RPCQuirks            bool          `long:"rpcquirks" description:"Mirror some JSON-RPC quirks of Picfightcoin Core -- NOTE: Discouraged unless interoperability issues need to be worked around"`
	...
	Generate             bool          `long:"generate" description:"Generate (mine) picfightcoins using the CPU"`
