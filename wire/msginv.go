...
// MsgInv implements the Message interface and represents a picfightcoin inv message.
...
func (msg *MsgInv) PfcDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count > MaxInvPerMsg {
		...
		return messageError("MsgInv.PfcDecode", str)
	}
...
// NewMsgInv returns a new picfightcoin inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new picfightcoin inv message that conforms to the
