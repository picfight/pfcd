...
// MsgVersion implements the Message interface and represents a picfightcoin version
...
// This is part of the Message interface implementation.
func (msg *MsgVersion) PfcEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
// NewMsgVersion returns a new picfightcoin version message that conforms to the
