...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.PfcEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.PfcDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.PfcEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.PfcDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.PfcEncode(w, test.pver, BaseEncoding)
		...
		err = msg.PfcDecode(r, test.pver, BaseEncoding)
