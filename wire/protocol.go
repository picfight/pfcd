...
const (
	...
	TestNet PicfightcoinNet = 0xdab5bffa

	// TestNet3 represents the test network (version 3).
	TestNet3 PicfightcoinNet = 0x0709110b
...
// String returns the PicfightcoinNet in human-readable form.
func (n PicfightcoinNet) String() string {
	if s, ok := bnStrings[n]; ok {
		return s
	}

	return fmt.Sprintf("Unknown PicfightcoinNet (%d)", uint32(n))
}
