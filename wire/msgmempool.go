...
// MsgMemPool implements the Message interface and represents a PicFight mempool
...
// NewMsgMemPool returns a new PicFight pong message that conforms to the Message
