...
// maxNetAddressPayload returns the max payload size for a picfightcoin NetAddress
...
type NetAddress struct {
	...
	// not present in the picfightcoin version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The picfightcoin protocol uses a uint32 for the timestamp so it will
