...
func BenchmarkDecodeGetHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.PfcEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetHeaders.PfcEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.PfcEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgHeaders.PfcEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeGetBlocks(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.PfcEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetBlocks.PfcEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeAddr(b *testing.B) {
	...
	// Serialize it so the bytes are available to test the decode below.
	var bb bytes.Buffer
	if err := ma.PfcEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgAddr.PfcEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeInv(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.PfcEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgInv.PfcEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeNotFound(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.PfcEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgNotFound.PfcEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeMerkleBlock(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.PfcEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgMerkleBlock.PfcEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
