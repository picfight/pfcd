...
// MsgGetData implements the Message interface and represents a picfight
...
// NewMsgGetData returns a new PicFight getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new PicFight getdata message that conforms to
