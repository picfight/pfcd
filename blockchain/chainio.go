...
// from the index, and return a pfcutil.Block with the height set.
...
// raw block for the provided height, deserialize it, and return a pfcutil.Block
// with the height set.
func dbFetchBlockByHeight(dbTx database.Tx, height int64) (*pfcutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int64) (*pfcutil.Block, error) {
