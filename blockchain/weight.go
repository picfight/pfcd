...
func GetBlockWeight(blk *pfcutil.Block) int64 {
...
func GetTransactionWeight(tx *pfcutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *pfcutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
