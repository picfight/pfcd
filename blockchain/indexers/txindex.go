...
func dbAddTxIndexEntries(dbTx database.Tx, block, parent *pfcutil.Block, blockID uint32) error {
...
// block (if they were valid) and every stake transaction in the passed block.
func dbRemoveTxIndexEntries(dbTx database.Tx, block, parent *pfcutil.Block) error {
