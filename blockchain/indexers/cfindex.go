...
func storeFilter(dbTx database.Tx, block *pfcutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *pfcutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *pfcutil.Block,
