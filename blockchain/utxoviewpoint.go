...
func (b *BlockChain) connectTransactions(view *UtxoViewpoint, block *pfcutil.Block, parent *pfcutil.Block, stxos *[]spentTxOut) error {
...
func (b *BlockChain) disconnectTransactions(view *UtxoViewpoint, block *pfcutil.Block, parent *pfcutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactionSlice(transactions []*pfcutil.Tx, height int64, stxosPtr *[]spentTxOut) (int, error) {
	if stxosPtr == nil {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block, parent *pfcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *pfcutil.Tx, treeValid bool) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
