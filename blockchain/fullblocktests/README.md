...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/picfight/dcrd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/picfight/dcrd/blockchain/fullblocktests
```
