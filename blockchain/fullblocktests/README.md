...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/picfight/pfcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/picfight/pfcd/blockchain/fullblocktests
```
