...
// children nodes.  A diagram depicting how this works for picfightcoin transactions
...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*pfcutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *pfcutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *pfcutil.Block) error {
