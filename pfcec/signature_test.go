...
var signatureTests = []signatureTest{
	// signatures from picfightcoin blockchain tx
	...
	// at all. When not parsing DER signatures, which is done by by picfightcoind
...
func TestSignatureSerialize(t *testing.T) {
	tests := []struct {
		...
		// signature from picfightcoin blockchain tx
		// 0437cd7f8525ceed2324359c2d0ba26006d92d85
		{
...
// The cases are borrowed from github.com/fjl/pfcec-issue.
