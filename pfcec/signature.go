...
// case in step 1.6. This counter is used in the picfightcoin compressed signature
// format and thus we match picfightcoind's behaviour here.
...
func SignCompact(curve *KoblitzCurve, key *PrivateKey,
	...
	// picfightcoind checks the bit length of R and S here. The ecdsa signature
