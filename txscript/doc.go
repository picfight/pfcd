...
/*
Package txscript implements the PicFight transaction script language.

This package provides data structures and functions to parse and execute
picfight coin transaction scripts.

Script Overview

PicFight transaction scripts are written in a stack-base, FORTH-like language.

The PicFight script language consists of a number of opcodes which fall into
...
The vast majority of PicFight scripts at the time of this writing are of several
...
what conditions must be met in order to spend picfight coins.
