...
/*
Package txscript implements the picfightcoin transaction script language.

A complete description of the script language used by picfightcoin can be found at
...
Picfightcoin transaction scripts are written in a stack-base, FORTH-like language.

The picfightcoin script language consists of a number of opcodes which fall into
...
The vast majority of Picfightcoin scripts at the time of this writing are of several
