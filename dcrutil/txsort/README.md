...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/picfight/dcrd/dcrutil/txsort)
...
```bash
$ go get -u github.com/picfight/dcrd/dcrutil/txsort
```
