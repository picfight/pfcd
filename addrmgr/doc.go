...
/*
Package addrmgr implements concurrency safe Picfightcoin address manager.

Address Manager Overview

In order maintain the peer-to-peer Picfightcoin network, there needs to be a source
of addresses to connect to as nodes come and go.  The Picfightcoin protocol provides
