...
require (
	...
	github.com/picfight/pfcd/hdkeychain v1.1.0
	github.com/picfight/pfcd/mempool v1.0.1
	github.com/picfight/pfcd/mining v1.0.1
	github.com/picfight/pfcd/peer v1.0.1
	github.com/picfight/pfcd/rpcclient v1.0.1
