...
func TestChainSvrWsNtfns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "blockconnected",
			newNtfn: func() (interface{}, error) {
				return pfcjson.NewCmd("blockconnected", "header", []string{"tx0", "tx1"})
			},
			staticNtfn: func() interface{} {
				return pfcjson.NewBlockConnectedNtfn("header", []string{"tx0", "tx1"})
			},
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return pfcjson.NewCmd("blockdisconnected", "header")
			},
			staticNtfn: func() interface{} {
				return pfcjson.NewBlockDisconnectedNtfn("header")
			},
