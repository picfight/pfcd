pfcd allows you to bind the RPC server to specific interfaces which enables you
...
|--rpclisten=:9709|all interfaces on port 9709|
|--rpclisten=0.0.0.0:9709|all IPv4 interfaces on port 9709|
|--rpclisten=[::]:9709|all IPv6 interfaces on port 9709|
|--rpclisten=127.0.0.1:9709|only IPv4 localhost on port 9709|
|--rpclisten=[::1]:9709|only IPv6 localhost on port 9709|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:9709|IPv4 localhost on port 8337 and IPv6 localhost on port 9709|
|--rpclisten=:9709 --listen=:8337|all interfaces on ports 9709 and 8337|
